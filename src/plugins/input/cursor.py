...
def move(x: int, y: int, duration: float = 0) -> None:
    ...
    Keywords: cursor, move, cursor_move, mouse, mouse_move, pointer, coordinate, mousemove, Linux-MCP
    """
...
def click(button: Literal['left','right','middle'] = 'left', clicks_count: int = 1) -> None:
    ...
    Keywords: cursor, move, cursor_click, mouse, mouse_click, click, left click, right click, double click, press, Linux-MCP
    """
